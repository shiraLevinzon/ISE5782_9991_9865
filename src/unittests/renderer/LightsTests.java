...
public class LightsTests {
	...
	public void spherePoint() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new PointLight(spCL, spPL,0,0,0).setkL(0.001).setkQ(0.0002));
	...
	public void sphereSpot() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(spCL, spPL, new Vector(1, 1, -0.5),0,0,0).setkL(0.001).setkQ(0.0001));
	...
	public void trianglesPoint() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.add(new PointLight(trCL, trPL,0,0,0).setkL(0.001).setkQ(0.0002));
	...
	public void trianglesSpot() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.add(new SpotLight(trCL, trPL, trDL,0,0,0).setkL(0.001).setkQ(0.0001));
	...
	public void sphereSpotSharp() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(spCL, spPL, new Vector(1, 1, -0.5),0,0,0).setkL(0.001).setkQ(0.00004));
	...
	public void trianglesSpotSharp() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.add(new SpotLight(trCL, trPL, trDL,0,0,0).setkL(0.001).setkQ(0.00004));
